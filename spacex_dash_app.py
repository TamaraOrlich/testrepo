...
def get_pie_chart(selected_site):
    if selected_site == 'ALL':
        # Group by 'Launch Site' and sum up the 'class' column to get the total number of successes per site.
        ...
        # Filter the dataframe for the selected site and sum up the 'class' column.
        filtered_df = spacex_df[spacex_df['Launch Site'] == selected_site]
        success_count = filtered_df['class'].sum()
        failure_count = filtered_df.shape[0] - success_count
        fig = px.pie(
